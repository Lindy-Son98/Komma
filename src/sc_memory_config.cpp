...
sc_memory_params ScMemoryConfig::GetParams()
{
  ...
  {
    SC_LOG_WARNING(
        "Option `repo_path` in `[sc-memory]` group is deprecated since Komma 0.10.0. Use option "
        "`storage` instead.");
  ...
  {
    SC_LOG_WARNING(
        "Option `extensions_path` in `[sc-memory]` group is deprecated since Komma 0.10.0. Use option "
        "`extensions` instead.");
    GetStringListByKey(
        "extensions_path",
  ...
  if (HasKey("save_period"))
  {
    SC_THROW_EXCEPTION(
        ...
        "Error: Option `save_period` in `[sc-memory]` group is removed in Komma 0.10.0. Use option "
  ...
  if (HasKey("update_period"))
  {
    SC_THROW_EXCEPTION(
        utils::ExceptionInvalidParams,
        "Error: Option `update_period` in `[sc-memory]` group is removed in Komma 0.10.0. Use "
